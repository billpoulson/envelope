...
export function BundleSubnav({ projectSlug, bundleName }: Props) {
  ...
  return (
    <nav className="mb-6 flex flex-wrap gap-2 border-b border-border/60 pb-3" aria-label="Bundle sections">
